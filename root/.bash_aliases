...
alias flash="cd ~/md380tools && ./md380-dfu upgrade ~/firmware-noGPS.bin && echo -e '\033[1;32mFirmware write completed.  Turn radio off then on now.\033[0m' && sleep 5 && cd ~ && ~/md380tools-vm/menuopts"
alias flashgps="cd ~/md380tools && ./md380-dfu upgrade ~/firmware-GPS.bin && echo -e '\033[1;32mFirmware write completed.  Turn radio off then on now.\033[0m' && sleep 5 && cd ~ && ~/md380tools-vm/menuopts"
