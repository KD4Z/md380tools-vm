...
alias glvdale="cd ~/ && echo -e '\033[1;37mUpdating the KD4Z Toolkit' && echo -e '\033[1;32m' && rm -rf ~/md380tools-vm ~/md380tools && git clone https://github.com/KD4Z/md380tools-vm.git && touch ~/md380tools-vm/glv.dale && echo -e '\033[1;37mUpdating md380tools from Dale-W7DA' && echo -e '\033[1;32m' && git clone https://github.com/DaleFarnsworth/md380tools.git && echo -e '\033[1;32m' && chmod +x ~/md380tools-vm/init && ~/md380tools-vm/init && ~/build"
...
alias flashdb="~/flashidb"
alias flashidb="~/flashidb"
alias flashdbold="~/flashdb"
