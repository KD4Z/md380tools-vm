...
alias flashold="echo -e '\033[1;33mRadio should be connected in \033[1;31mDFU mode\033[1;33m now...\033[0m' && sleep 1 && cd ~/md380tools && ./md380-dfu upgrade ~/firmware-OLD.bin && echo -e '\033[1;32mFirmware write completed.  Turn radio off then on now.\033[0m' && sleep 5 && cd ~ && ~/md380tools-vm/menuopts"
